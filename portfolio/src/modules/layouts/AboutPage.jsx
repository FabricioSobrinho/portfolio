  ...
  return (
    <div id="aboutSection" className={styles.aboutSection}>
      <div className={styles.mainAboutCard} id="mainAbout">
        ...
        <div className={styles.rightAboutCard}>
          <p>
            Sou desenvolvedor estudando front e backend. <br />
            Faço curso de Análise e Desenvolvimento de Sistemas presencialmente
            na Unifasipe. <br />
            Atualmente estou estudando as tecnologias de Ruby e seu framework
            Rails, além de JS com o Node JS para o backend. <br />
